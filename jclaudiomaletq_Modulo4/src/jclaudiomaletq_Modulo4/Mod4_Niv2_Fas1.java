...
import java.util.*;
	 ...
	 * en cas de que l'usuari no introdueixi cap de les paraules clau. 
	 * S'ha de tornar a preguntar si es vol seguir demanant o no. 
	 */
public class Mod4_Niv2_Fas1 {
...
// static int busca_pos(String texto,String [] lista) 
public static int busca_pos(String texto,String [] lista)
		throws Longitud_erronea  {  //
		int res = 999;  
...
//	public Longitud_erronea () {}
	public Longitud_erronea(String message) {
		super();
